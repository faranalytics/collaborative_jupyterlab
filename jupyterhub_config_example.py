...
c.JupyterHub.bind_url = "http://0.0.0.0:8443/"
c.JupyterHub.hub_bind_url = "http://127.0.0.1:8081"
c.ConfigurableHTTPProxy.api_url = "http://127.0.0.1:8001"
c.JupyterHub.ssl_cert = "/etc/ssl/private/ssl.crt"
c.JupyterHub.ssl_key = "/etc/ssl/private/ssl.key"

c.JupyterHub.load_groups = {'users': USERS}

c.JupyterHub.load_roles = [
    {
        "name": "classroom",
        "groups": ["users"],
        "scopes": [f"access:services!service=classroom"],
    },
]
...
c.JupyterHub.services = [
    {
        ...
        'command': ["jupyterhub-singleuser", "--debug", "--collaborative"],
        'user': "classroom",
        'cwd': "/home/classroom",
